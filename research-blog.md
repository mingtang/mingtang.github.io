...
<div class="page-content wc-container">
	...
	<div class="post-box" style="margin-bottom:48px">
		...
		<div class="box-text">
			...
			<p>Some of my Ph.D. projects are analytically challenging, which require measurements of either high precision or extremely small sample sizes (e.g., ~10<sup>-17</sup> g). These challenges drove me to study the instruments—how they work and how to optimize them for my research purposes... <a href="{{ site.url }}/research-blog/2017/04/02/la/">Read More</a></p>
		</div>
	</div>
</div>
