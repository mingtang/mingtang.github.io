...
{:#caption}
**Fig. 2**. Superstructure of the Kola Superdeep Borehole, 2007. Image from Wikipedia.

Although cumulates are usually deep seated, there are very few places in the world where we have found crustal cumulates from this deep. 50-80 km is about twice that of the average continental crust thickness. It's unusual, and only the crust beneath the highest mountains can be built up to this thickness. Every piece of rock has its story. These deep rocks from the roots of mountains may hold the key to the ultimate mysteries of Earth's continents. 

Niobium (Nb) and Tantalum (Ta) are probably unfamiliar to most people. They are two metal elements, buried deep in the periodic table. Nb and Ta very rare in Earth's crust, a few parts per million or less. They have almost identical chemical properties and behave in pretty much the same ways in most geological processes. Their ratio is constant in Earth's mantle and the magmas that come from the mantle. When there is more Nb, there is more Ta; when there is less Nb, there is less Ta too. They are twins. 

But geologists have long noticed that the ratio of these twin elements is a little different in Earth's continental crust—Nb is off—it's lower than it should be. The twins are now separated with some of the Nb being missing in the continental crust. 
...
{:#caption}
**Fig. 3**. Andes mountains on the west coast of South America. Image from web.
...
{:#caption}
**Fig. 4**. Ojos Del Saldo volcano in the Andes, with an elevation of 6893 m, is the highest elevation volcano in the world. Image from web.
...
{:#caption}
**Fig. 5**. A rutile crystal (redish) in our samples. It's about 80 micron in diameter, a little more the thickness of human hair.
...
{:#caption}
**Fig. 6**. I took this photo last year in Tibet as we drove around Yamdrok Lake. In just about every glacial valley, where a stream runs down the mountains, there is a village. Lands are probably more fertile in the valley.
